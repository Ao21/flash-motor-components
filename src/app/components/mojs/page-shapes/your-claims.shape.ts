...
export class YourClaimsShape extends CustomShape {
	getShape() {
		return `<path d="M70.4,85H59.6v-5.8h10.8c0.4,0,0.4,0,0.4,0s0.8-1.2,0.8-6.2v-5.4c0-6.2-18.8-9.6-25-9.6h-5.4
...
<rect y="79.2" width="38.3" height="5.4"/>
<path d="M48.8,96.2c-7.5,0-13.3-5.8-13.3-13.3c0-7.5,5.8-13.3,13.3-13.3s13.3,5.8,13.3,13.3
	S56.2,96.2,48.8,96.2z M48.8,75.4c-4.2,0-7.5,3.3-7.5,7.5s3.3,7.5,7.5,7.5s7.5-3.3,7.5-7.5S53.3,75.4,48.8,75.4z"/>
<circle cx="48.8" cy="82.9" r="4.2"/>
<path d="M26.7,60.8H3.8c-1.3,0-2.1-0.8-2.1-2.1V46.7c0-0.8,0.4-1.2,0.8-1.7c0.4-0.4,1.3-0.4,1.7-0.4
...
<polygon points="88.8,61.7 70.4,56.7 72.1,51.2 79.6,53.3 75.8,42.5 85.8,38.8 76.2,34.2 80.4,24.2 
...
<rect x="57.9" y="74.2" width="16.7" height="2.9"/>
<rect y="74.2" width="40.8" height="2.9"/>
